...
本题的目标区域为半径1800米的圆域，机器狗从圆心出发，移动速度为5米/秒，测向机初始频道为1。每个频道至多有一个干扰源，有效接收半径在1000至1500米之间，示向误差不超过$1^\circ$。全向源在接收范围内均可检测，定向源还要求检测点位于其发射前方。进入目标20米范围后，机器狗可完成光学定位与清除。搜索过程因此同时受到几何位置、发射方向和操作耗时的影响。
