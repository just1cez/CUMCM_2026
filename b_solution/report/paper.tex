...
\vspace{0.6em}
{\small 研究与复核稿：含20轮官方演练；新策略尚待官方确认，正式材料未齐}
\end{center}
...
在Q3、Q4各10轮官方演练中，原策略分别清除139/139与138/138个源；移动占虚拟时间约74.38\%和73.20\%。据此提出\texttt{field}：保留原路线作为控制，加入多初解、2-opt与单点搬移；Q3另用负观测的保守凸外包、原地预检测及认证清除点接近减少移动。冻结后，在每问1000个新合成世界上，相对原\texttt{refined}的单源耗时由\FieldQThreeControl{}、\FieldQFourControl{}秒降至\FieldQThreeTime{}、\FieldQFourTime{}秒，降低\FieldQThreeGain\%和\FieldQFourGain\%，两题均全清。新确认、压力和误差替代试验共\FieldRuns{}次，全部逐动作复算计时；聚集源部分组的区间仍含零，不主张普遍占优。这些提升是本地配对证据，不冒充新策略的官方成绩。
